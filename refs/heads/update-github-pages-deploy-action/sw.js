...
self.__precacheManifest = [
  {
    "url": "webpack-runtime-bdbc043fffbcf99c2f20.js"
  },
  {
    "url": "framework-b184e9a11f9b35f26f7b.js"
  },
  {
    "url": "app-9f5ad4af8fc3073d9c85.js"
  },
  {
    "url": "offline-plugin-app-shell-fallback/index.html",
    "revision": "5074412824f0a5f645d86a273413f542"
  },
  {
  ...
  },
  {
    ...
    "revision": "063f0fdb432010fce06fb475a0074bdb"
  },
  {
...
const navigationRoute = new NavigationRoute(async ({ event }) => {
  ...
  pathname = pathname.replace(new RegExp(`^/age-online/refs/heads/update-github-pages-deploy-action`), ``)

  // Check for resources + the app bundle
  // The latter may not exist if the SW is updating to a new version
  const resources = await idbKeyval.get(`resources:${pathname}`)
  if (!resources || !(await caches.match(`/age-online/refs/heads/update-github-pages-deploy-action/app-9f5ad4af8fc3073d9c85.js`))) {
    return await fetch(event.request)
  }
  ...
  const offlineShell = `/age-online/refs/heads/update-github-pages-deploy-action/offline-plugin-app-shell-fallback/index.html`
