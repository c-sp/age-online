...
export function AppCommonHead({pathPrefix}: IAppCommonHeadProps): ReactElement {
    ...
    return <>
        ...
        */}
        <link rel="apple-touch-icon" sizes="180x180" href={`${prefix}/apple-touch-icon.png?v=BGa7OnrlGG`}/>
        <link rel="icon" type="image/png" sizes="32x32" href={`${prefix}/favicon-32x32.png?v=BGa7OnrlGG`}/>
        <link rel="icon" type="image/png" sizes="16x16" href={`${prefix}/favicon-16x16.png?v=BGa7OnrlGG`}/>
        <link rel="manifest" href={`${prefix}/site.webmanifest?v=BGa7OnrlGG`}/>
        <link rel="mask-icon" href={`${prefix}/safari-pinned-tab.svg?v=BGa7OnrlGG`} color="#5050ff"/>
        <link rel="shortcut icon" href={`${prefix}/favicon.ico?v=BGa7OnrlGG`}/>
        <meta name="apple-mobile-web-app-title" content="AGE Online"/>
        <meta name="application-name" content="AGE Online"/>
        <meta name="msapplication-TileColor" content="#da532c"/>
        <meta name="msapplication-config" content={`${prefix}/browserconfig.xml?v=BGa7OnrlGG`}/>
